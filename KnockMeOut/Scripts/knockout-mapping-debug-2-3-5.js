    ...
    visitPropertiesOrArrayEntries(unwrappedRootObject, function(indexer) {
      ...
      if (ko.utils.arrayIndexOf(options.copy, indexer) === -1) {
        ...
        if (ko.utils.arrayIndexOf(options.include, indexer) === -1) {
          ...
          if (unwrappedRootObject[mappingProperty] && unwrappedRootObject[mappingProperty].mappedProperties && !unwrappedRootObject[mappingProperty].mappedProperties[indexer] && unwrappedRootObject[mappingProperty].copiedProperties && !unwrappedRootObject[mappingProperty].copiedProperties[indexer] && !(exports.getType(unwrappedRootObject) === "array")) {
            return;
          }
        }
      }
